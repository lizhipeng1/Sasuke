...
public abstract class ReflectionUtils {
    ...
    public static void set(String fieldName, Object fieldValue, Class<?> fieldClass, Object target) {
        Class<?> modelClass = target.getClass();
        String fieldSetter = null;
        Field field = null;
        try {
            field = modelClass.getDeclaredField(fieldName);
            fieldSetter = getSetterMethodName(fieldName, field.getType());
            Method method = modelClass.getMethod(fieldSetter, new Class<?>[]{field.getType()});
            method.invoke(target, new Object[]{fieldValue});
        } catch (NoSuchMethodException e) {
            throw new IllegalArgumentException(
                    "JavaReflectionUtils.set" + e.getMessage() + " fieldSetter:" + fieldSetter + " fieldName:" + fieldName
                            + " fieldGetType:" + field.getType(), e
            );
            ...
            throw new IllegalArgumentException(
                    "JavaReflectionUtils.set" + e.getMessage() + " fieldSetter:" + fieldSetter + " fieldName:" + fieldName
                            + " classname:" + modelClass.getName(), e
            );
        }
    }

    public static void methodSet(String setter, Object fieldValue, Class<?> fieldClass, Object target) {
        Class<?> modelClass = target.getClass();

        try {
            Method method = modelClass.getMethod(setter, new Class<?>[]{fieldClass});
            method.invoke(target, new Object[]{fieldValue});
        } catch (NoSuchMethodException e) {
            throw new IllegalArgumentException("JavaReflectionUtils.set" + e.getMessage(), e);
        } catch (SecurityException e) {
            throw new RuntimeException("JavaReflectionUtils.set" + e.getMessage(), e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("JavaReflectionUtils.set" + e.getMessage(), e);
        } catch (InvocationTargetException e) {
            throw new RuntimeException("JavaReflectionUtils.set" + e.getMessage(), e);
    ...
    public static <T> T get(String fieldName, Class<?> fieldClass, Object model) {
        Class<?> modelClass = model.getClass();
        try {
            Field field = modelClass.getDeclaredField(fieldName);
            String fieldGetter = getGetterMethodName(fieldName, field.getType());
            Method method = modelClass.getMethod(fieldGetter, new Class<?>[]{});

            Object o = method.invoke(model, new Object[]{});
            return o == null ? null : (T) o;
        } catch (NoSuchMethodException e) {
            throw new IllegalArgumentException("JavaReflectionUtils.get" + e.getMessage(), e);
        } catch (SecurityException e) {
            throw new RuntimeException("JavaReflectionUtils.get" + e.getMessage(), e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("JavaReflectionUtils.get" + e.getMessage(), e);
    ...
    @SuppressWarnings("unchecked")
    public static <T> T methodGet(String getter, Class<?> fieldClass, Object model) {
        try {
            Class<?> modelClass = model.getClass();
            Method method = modelClass.getMethod(getter, new Class<?>[]{});

            Object o = method.invoke(model, new Object[]{});
            return o == null ? null : (T) o;
        } catch (SecurityException e) {
            throw new RuntimeException(
                    "JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + "fieldClass:" + fieldClass + " ", e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException(
                    "JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + "fieldClass:" + fieldClass + " ", e);
        } catch (IllegalArgumentException e) {
    ...
    @SuppressWarnings("unchecked")
    public static <T> T methodGet(String getter, Object model) {
        Class<?> modelClass = model.getClass();
        ...
        try {
            ...
            throw new RuntimeException("JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + " ", e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + " ", e);
        } catch (IllegalArgumentException e) {
            throw new IllegalArgumentException("JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + " ", e);
        } catch (InvocationTargetException e) {
            throw new RuntimeException("JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + " ", e);
        } catch (NoSuchMethodException e) {
            throw new IllegalArgumentException("JavaReflectionUtils.get" + e.getMessage() + "getter " + getter + " ", e);
    ...
    public static String getGetterMethodName(String fieldName, Class<?> fieldClass) {
    ...
    public static String getSetterMethodName(String fieldName, Class<?> fieldClass) {
        if (boolean.class == fieldClass && fieldName.startsWith("is")) {
            return "set" + fieldName.substring(2);
        }
        return "set" + StringUtils.capitalize(fieldName);
    }

    public static String nameGetToSet(String getter) {
        if (getter.startsWith("get")) {
            return "s" + getter.substring(1);
        } else {
            return "set" + getter.substring(2);
        }
    }

    public static String nameSetToGet(String setter, Class<?> fieldClass) {
    ...
    private static Map<String, Object> OBJECT_CACHE = new HashMap<String, Object>();

    @SuppressWarnings("unchecked")
    public static <T> T newInstance(String className) {
        T t = (T) OBJECT_CACHE.get(className);
        try {
            if (t == null) {
                Class<?> clazz = Class.forName(className);
                t = (T) clazz.newInstance();
                OBJECT_CACHE.put(className, t);
            }
        } catch (ClassNotFoundException e) {
            throw new IllegalArgumentException("JavaReflectionUtils.newInstance" + e.getMessage(), e);
        } catch (InstantiationException e) {
            throw new RuntimeException("JavaReflectionUtils.newInstance" + e.getMessage(), e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("JavaReflectionUtils.newInstance" + e.getMessage(), e);
        }
        return t;
     ...
     */
    public static <T> Class<T> getSuperClassGenericType(final Class targetClass) {
        return getSuperClassGenericType(targetClass, 0);
    }
     ...
     * @return class
     */
    public static Class getSuperClassGenericType(final Class targetClass,
                                                 final int index) {
        ...
        if (!(params[index] instanceof Class)) {
            logger.warn(targetClass.getSimpleName()
                    + " not set the actual Class targetClass superclass generic parameter");
            return Object.class;
        }
    ...
    public  static Class[] getMethodParamClass(Object target,String propertyName ){
        ...
        for(Method method :methods){
            if(method.getName().equals(setterMethodName)){
                backcls=method.getParameterTypes();
            }
        }
        return backcls;
    }
